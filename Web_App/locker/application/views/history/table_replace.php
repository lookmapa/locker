<!--  content -->
				<div class="col-md-10" >
					<div class="panel panel-primary" style="margin:2% 0% 1% 0%;">
	  					<div class="panel-heading">
	    					<h3 class="panel-title"> รายงานการเปิดห้องแทน </h3>
	  					</div>
		...
		<form id="fexport" method="post" action="<?php echo base_url();?>report_controller/list_replace">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".btn-search").click(function(){
			...
			$.ajax({
				url: $("input[name='url']").val()+"history_controller/list_replace",
				type: "post",
				data: {
					user : user,
